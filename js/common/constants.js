...
// Game arithmetic
export var CHARACTERS_PER_WORD = 5;
// Unit conversions
export var MILLISECONDS_PER_HOUR = 3600000;
export var MILLISECONDS_PER_MINUTE = 60000;
export var MILLISECONDS_PER_SECOND = 1000;
export var SECONDS_PER_HOUR = 3600;
export var SECONDS_PER_MINUTE = 60;
export var MINUTES_PER_HOUR = 60;
// Other
export var phraseItemCollectionNameToArrayMap = {
