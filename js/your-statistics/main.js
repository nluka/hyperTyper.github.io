...
import { clearStatisticsStorage_button, toggleVisibilityAccuracyStatistics_button, toggleVisibilityParticipationStatistics_button, toggleVisibilityWpmStatistics_button } from "./page-elements.js";
import ElementVisibility from "../common/ElementVisibility.js";
handleInternetExplorer();
var pageLoader = new PageLoader();
var navbar = new Navbar();
var wpmTable = new WpmTable();
var accuracyTable = new AccuracyTable();
var participationTable = new ParticipationTable();
function main() {
...
function applyStoredVisibilitySettingsForAllCollapsibleElements() {
    ElementVisibility.applyStoredSettings(wpmTable.tableElement, WpmTable.ELEMENT_ID, wpmTable.toggleVisibilityButtonElement, WpmTable.DEFAULT_IS_VISIBLE_BOOL);
    ElementVisibility.applyStoredSettings(accuracyTable.tableElement, AccuracyTable.ELEMENT_ID, accuracyTable.toggleVisibilityButtonElement, AccuracyTable.DEFAULT_IS_VISIBLE_BOOL);
    ElementVisibility.applyStoredSettings(participationTable.tableElement, ParticipationTable.ELEMENT_ID, participationTable.toggleVisibilityButtonElement, ParticipationTable.DEFAULT_IS_VISIBLE_BOOL);
}
function addButtonClickEventListenersForAllElementVisibilityTogglers() {
    ElementVisibility.addToggleButtonClickEventListener(wpmTable.tableElement, WpmTable.ELEMENT_ID, toggleVisibilityWpmStatistics_button);
