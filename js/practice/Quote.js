...
var Quote = /** @class */ (function () {
    ...
    Quote.get = function () {
        return __awaiter(this, void 0, void 0, function () {
            var responseFromQuotableApi, content, author, localQuote;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, QuotableApi.get()];
                    case 1:
                        responseFromQuotableApi = _a.sent();
                        if (this.isQuoteableApiResponseValid(responseFromQuotableApi)) {
                            ...
                            localQuote = LocalQuote.get();
                            content = localQuote.content;
                            author = localQuote.author;
                        }
                        return [2 /*return*/, new GameText(this.getQuoteContentWithSettingsApplied(content), author)];
                }
            });
        });
    };
    Quote.getQuoteContentWithSettingsApplied = function (quoteContent) {
        if (!settings.getPunctuation()) {
            return StringEditor.getWithNoPunctuation(quoteContent);
        }
        return quoteContent;
    };
    Quote.isQuoteableApiResponseValid = function (response) {
        if (
        //response === null ||
        //response === undefined ||
