...
import {
  ...
  phrasePunctuationFrequencyTooltipIcon_div,
...
export const gameWpmTracker = new GameWpmTracker();
export const gameActionButton = new GameActionButton();
export const expression = new Expression();
export const gameInput = new GameInput();
export const keyboardVisual = new KeyboardVisual();
export const settingsMenu = new SettingsMenu();
export const gameStatisticsTable = new GameStatisticsTable();
...
function applyStoredSettingsForAllCollapsibleElements() {
  ElementVisibility.applyStoredSettings(
    settingsMenu.containerElement,
    SettingsMenu.ELEMENT_ID,
    settingsMenu.toggleVisibilityButtonElement,
    SettingsMenu.DEFAULT_IS_VISIBLE_BOOL
  );
  ElementVisibility.applyStoredSettings(
    gameStatisticsTable.tableElement,
    GameStatisticsTable.ELEMENT_ID,
    gameStatisticsTable.toggleVisibilityButtonElement,
    GameStatisticsTable.DEFAULT_IS_VISIBLE_BOOL
  );
  ElementVisibility.applyStoredSettings(
    mistakeAnalyzer.containerElement,
    MistakeAnalyzer.ELEMENT_ID,
    mistakeAnalyzer.toggleVisibilityButtonElement,
    MistakeAnalyzer.DEFAULT_IS_VISIBLE_BOOL
  );
}
